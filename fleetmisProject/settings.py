"""
Django settings for fleetmisProject project.
...
SECRET_KEY = 'django-insecure-jp(sk_4u07w!f*awus!3yiri+dto+qu(h(eao6p%9_aj!o+@v('
...
WSGI_APPLICATION = 'fleetmisProject.wsgi.application'
...
# TO support Upload Passport photo 
MEDIA_URL = '/media/'
