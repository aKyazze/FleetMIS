# Generated by Django 4.2.11 on 2025-05-25 16:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('HR', 'Human Resource'), ('IS', 'Information System(IT)'), ('FIN', 'Finance'), ('COM', 'COmmercial'), ('FLT', 'Fleet')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Driver',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_photo', models.ImageField(blank=True, null=True, upload_to='staff_photos/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_type', models.CharField(choices=[('Saloon', 'Saloon Car'), ('SUV', 'SUV (Sport Utility Vehicle)'), ('Pickup', 'Pickup Truck'), ('Truck', 'Cargo Truck'), ('Motorcycle', 'Motorcycle'), ('Van', 'Van'), ('DoubleCab', 'Double Cabin')], max_length=20)),
                ...
                ('service_status', models.CharField(choices=[('PENDING', 'Pending'), ('IN_PROGRESS', 'In Progress'), ('COMPLETED', 'Completed')], default='PENDING', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('contact', models.CharField(max_length=15)),
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female')], max_length=1)),
                ('passport_photo', models.ImageField(blank=True, null=True, upload_to='driver_photos/')),
                ('department', models.CharField(choices=[('HR', 'Human Resource'), ('IS', 'Information System(IT)'), ('FIN', 'Finance'), ('COM', 'COmmercial'), ('FLT', 'Fleet')], max_length=20)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='userprofile', to='fleetApp.staff')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fleetApp.serviceprovider'),
        ),
        migrations.AddField(
            model_name='service',
            name='vehicle',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fleetApp.vehicle'),
        ),
        migrations.CreateModel(
            name='Requestor',
            fields=[
        ...
        migrations.AddField(
            model_name='driver',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='fleetApp.staff'),
        ),
        migrations.AddField(
            model_name='driver',
            name='vehicle',
